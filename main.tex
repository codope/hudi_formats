...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[x=1mm, y=1mm]
    ...
    % \draw[densely dashed, thin, gray!60] (14,14) -- (14,-6)                 node[annot, below] {indexing instant};
